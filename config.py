...
train_label_paths = {
    ...
    "WLBSL": "./data/WLBSL/WLBSL_Labels.csv",   # <— add
}
...
rgb_dirs = {
    ...
    "WLBSL": "./dataset/WLBSL/rgb_format",      # <— add (expects train/dev/test subfolders)
}
...
pose_dirs = {
    ...
    "WLBSL": "./dataset/WLBSL/pose_format",     # <— add (expects train/dev/test subfolders)
}
